...
class Dem2Test(unittest.TestCase):
    ...
    def test_function(self):
        ...
        self.assertEquals(return_value, 'Done!')
        
    def test_outputs(self):
        self.load_r()
        r_dem2 = robjects.globalenv['Demonstrate2']
        r_dem2(self.testdir)
        outputnames = ['Comparison Table.csv', 'TP Histograms.pdf', 'FP Histograms.pdf', 'True Positives vs. False Positives.pdf', 'Plot of AUC by MAE.pdf']
